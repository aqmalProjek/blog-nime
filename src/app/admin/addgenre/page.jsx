  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
          ...
          <div className="form-control w-full ">
            ...
            <textarea className="textarea textarea-bordered" placeholder="Genre Deskripsi" defaultValue={genreDescription} onChange={(e) => setGenreDescription(e.target.value)}></textarea>
          </div>
